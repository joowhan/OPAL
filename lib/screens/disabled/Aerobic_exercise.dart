...
class aerobic_exercise extends StatefulWidget {
  @override
  _aerobic_exerciseState createState() => _aerobic_exerciseState();
}

class _aerobic_exerciseState extends State<aerobic_exercise> {
