...
class flexibility_elbowsToBody extends StatelessWidget {
  @override
...
class elbowsToBody extends StatefulWidget {
  @override
  _elbowsToBodyState createState() => _elbowsToBodyState();
}

class _elbowsToBodyState extends State<elbowsToBody> {
...
''',
                ...
                //   width: 20,
                // ),
                Center(child: Image.asset('images/elbowsbackhead.png')),
              ],
            ))
        // ),
      ],
...
class elbowstoBodyRest extends StatelessWidget {
  var done = false;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
