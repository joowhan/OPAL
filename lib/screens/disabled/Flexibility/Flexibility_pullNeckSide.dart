...
class flexibility_pullNeckSide extends StatelessWidget {
  @override
...
class pullNeckSide extends StatefulWidget {
  @override
  _pullNeckSideState createState() => _pullNeckSideState();
}

class _pullNeckSideState extends State<pullNeckSide> {
...
''',
                ...
                //   width: 20,
                // ),
                Center(child: Image.asset('images/diagonneck.png')),
              ],
            ))
        // ),
      ],
...
class pullNeckSideRest extends StatelessWidget {
  var done = false;
  @override
  hexColor(String colorhexcode) {
    String colornew = '0xff' + colorhexcode;
