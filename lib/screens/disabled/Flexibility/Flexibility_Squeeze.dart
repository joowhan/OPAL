...
class flexibility_squeeze extends StatelessWidget {
  @override
...
class squeeze extends StatefulWidget {
  @override
  _squeezeState createState() => _squeezeState();
}
...
''',
                ...
                //   width: 20,
                // ),
                Center(child: Image.asset('images/backwaist.png')),
              ],
            ))
        // ),
      ],
...
class squeezeRest extends StatelessWidget {
  var done = false;
  @override
  hexColor(String colorhexcode) {
    String colornew = '0xff' + colorhexcode;
              ...
              child: RaisedButton.icon(
                onPressed: () {
                  Navigator.push(context,
                      CupertinoPageRoute(builder: (context) => EighthScreen()));
                  //Navigator.pushNamed(context, '/first');
                },
                shape: RoundedRectangleBorder(
