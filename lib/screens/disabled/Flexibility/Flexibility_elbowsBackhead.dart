...
class flexibility_elbowsBackhead extends StatelessWidget {
  @override
...
class elbowsBackhead extends StatefulWidget {
  @override
  _elbowsBackheadState createState() => _elbowsBackheadState();
}

class _elbowsBackheadState extends State<elbowsBackhead> {
                        ...
                        valueListener: (timeElapsed) {
                          if (timeElapsed == Duration(seconds: 20))
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => elbowsBackheadRest()));
                          setState(() {
...
''',
                ...
                //   width: 20,
                //),
                Center(child: Image.asset('images/squeeze.png')),
              ],
            ))
        // ),
      ],
...
class elbowsBackheadRest extends StatelessWidget {
  var done = false;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              child: RaisedButton.icon(
                onPressed: () {
                  Navigator.push(context,
                      CupertinoPageRoute(builder: (context) => SeventhScreen()));
                  //Navigator.pushNamed(context, '/first');
                },
                shape: RoundedRectangleBorder(
