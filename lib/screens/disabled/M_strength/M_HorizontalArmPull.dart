...
class m_horizontalArmPull extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: horizontalArmPull(),
    );
  }
}
class horizontalArmPull extends StatefulWidget {
  @override
  _horizontalArmPullState createState() => _horizontalArmPullState();
}

class _horizontalArmPullState extends State<horizontalArmPull> {
                        ...
                        valueListener: (timeElapsed) {
                          if (timeElapsed == Duration(seconds: 20))
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => horizontalArmPullRest()));
                          setState(() {
...
class horizontalArmPullRest extends StatelessWidget {
  var done = false;
  @override
  hexColor(String colorhexcode) {
    String colornew = '0xff' + colorhexcode;
