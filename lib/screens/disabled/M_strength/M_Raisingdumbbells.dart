...
class m_raisingdumbbells extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: raisingdumbbells(),
    );
  }
}
class raisingdumbbells extends StatefulWidget {
  @override
  _raisingdumbbellsState createState() => _raisingdumbbellsState();
}

class _raisingdumbbellsState extends State<raisingdumbbells> {
                        ...
                        valueListener: (timeElapsed) {
                          if (timeElapsed == Duration(seconds: 20))
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => raisingdumbbellsRest()));
                          setState(() {
...
class raisingdumbbellsRest extends StatelessWidget {
  var done = false;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
