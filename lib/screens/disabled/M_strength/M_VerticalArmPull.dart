...
class m_verticalArmPull extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: verticalArmPull(),
    );
  }
}
class verticalArmPull extends StatefulWidget {
  @override
  _verticalArmPullState createState() => _verticalArmPullState();
}

class _verticalArmPullState extends State<verticalArmPull> {
                        ...
                        valueListener: (timeElapsed) {
                          if (timeElapsed == Duration(seconds: 20))
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => verticalArmPullRest()));
                          setState(() {
...
class verticalArmPullRest extends StatelessWidget {
  var done = false;
  @override
  hexColor(String colorhexcode) {
    String colornew = '0xff' + colorhexcode;
