...
import 'package:opalapp/screens/disabled/M_strength/M_page.dart';

class m_climbinghands extends StatelessWidget {
  @override
...
class climbinghands extends StatefulWidget {
  @override
  _climbinghandsState createState() => _climbinghandsState();
}

class _climbinghandsState extends State<climbinghands> {
                        ...
                        valueListener: (timeElapsed) {
                          if (timeElapsed == Duration(seconds: 100))
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => climbinghandsRest()));
                          setState(() {
...
class climbinghandsRest extends StatelessWidget {
  var done = false;
  @override
  hexColor(String colorhexcode) {
    String colornew = '0xff' + colorhexcode;
